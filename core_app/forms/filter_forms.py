...
class TeslaReturnFilterForm(Form):
    ...
    def clean(self):
        ...
        if end_date and end_date > date_today():
    ...
    def filter(self):
        ...
        # Reverse historical data so that the first index holds data from the start date
        ...
        for data in historical_data:
            ...
            if not self.extreme_return or day_data[0] > self.extreme_return[0]:
                self.extreme_return = day_data
